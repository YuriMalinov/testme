    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav" ng-cloak>
                ...
                <li ng-show="user.isAdmin"><a href="/admin#all-tests">Все тесты</a></li>
                <li ng-show="user.isAdmin"><a href="/admin#test-passes">Прохождения</a></li>
                <li ng-show="user.isAdmin"><a href="/admin#users">Пользователи</a></li>
            </ul>
